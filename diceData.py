...
print("Mean of dice result is = ",mean)
print("Median of dice result is = ",median)
print("Mode of dice result is = ",mode)

#1.Mean, median and mode will be almost the same - Normal Dist
#65% of data lies within 1 standard deviation
...
#calculating 1st, 2nd and third std
